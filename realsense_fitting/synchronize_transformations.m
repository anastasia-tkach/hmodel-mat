function [poses, alpha, phalanges] = synchronize_transformations(poses, blocks, alpha, names_map, display)
...
for p = 1:num_poses
    ...
    parameters{p}([16, 17, 20, 21, 24, 25, 28, 29]) = max(parameters{p}([16, 17, 20, 21, 24, 25, 28, 29]), -0.1);
end
