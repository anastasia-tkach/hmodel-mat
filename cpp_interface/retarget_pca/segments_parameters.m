...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 10, 11];
segment.local = [
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 10, 11, 12];
segment.local = [
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 10, 11, 12, 13];
segment.local = [
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 26, 27];
segment.local = [
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 26, 27, 28];
segment.local = [
...
segment.parent_id = 6;
segment.children_ids = [];
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 26, 27, 28, 29];
segment.local = [
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 22, 23];
segment.local = [
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 22, 23, 24];
segment.local = [
...
segment.parent_id = 9;
segment.children_ids = [];
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 22, 23, 24, 25];
segment.local = [
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 18, 19];
segment.local = [
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 18, 19, 20];
segment.local = [
...
segment.children_ids = [];
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 18, 19, 20, 21];
segment.local = [
 1  0  0  0;
 0  1  0 24;
 0  0  1  0;
...
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 14, 15, 16];
segment.local = [
...
segment.children_ids = [];
segment.kinematic_chain = [1, 2, 3, 4, 5, 6, 14, 15, 16, 17];
segment.local = [
   1    0    0    0;
   0    1    0 22.8;
   0    0    1    0;
