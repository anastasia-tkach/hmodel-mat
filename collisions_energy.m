...
for i = 1:length(blocks)-1
    for j = i + 1:length(blocks)
        ...
        normal = compute_model_normals_temp({surface_q}, centers, {blocks{j}}, radii); data_normals{k} = normal{1};
        ...
        normal = compute_model_normals_temp({surface_p}, centers, {blocks{i}}, radii); data_normals{k} = normal{1};
