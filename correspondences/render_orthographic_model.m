function [rendered_model, I] = render_orthographic_model(centers, blocks, radii, camera_matrix, camera_center, settings)
...
[U, V, D, I] = render_orthographic_model_mex(C, R, B, T, M, W, H, p);
disp('orthographic');
