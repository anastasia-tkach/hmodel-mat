...
% function [f, Jc1, Jr1, Jc2, Jr2] = energy1_case2_analytical(p, c1, c2, r1, r2)
% u = c2 - c1;
% v = p - c1;
% alpha = u' * v / (u' * u);
% t = c1 + alpha * u;
...
%% Final result
% f = sqrt((p - q)' * (p - q))
f = @(c1, c2, r1, r2) sqrt((p - q(c1, c2, r1, r2))' * (p - q(c1, c2, r1, r2)));
df_dc1 = @(c1, c2, r1, r2) - (p - q(c1, c2, r1, r2))' * dq_dc1(c1, c2, r1, r2) / sqrt((p - q(c1, c2, r1, r2))' * (p - q(c1, c2, r1, r2)));
df_dc2 = @(c1, c2, r1, r2) - (p - q(c1, c2, r1, r2))' * dq_dc2(c1, c2, r1, r2) / sqrt((p - q(c1, c2, r1, r2))' * (p - q(c1, c2, r1, r2)));
df_dr1 = @(c1, c2, r1, r2) - (p - q(c1, c2, r1, r2))' * dq_dr1(c1, c2, r1, r2) / sqrt((p - q(c1, c2, r1, r2))' * (p - q(c1, c2, r1, r2)));
df_dr2 = @(c1, c2, r1, r2) - (p - q(c1, c2, r1, r2))' * dq_dr2(c1, c2, r1, r2) / sqrt((p - q(c1, c2, r1, r2))' * (p - q(c1, c2, r1, r2)));

f = @(c1) f(c1, c2, r1, r2);
disp(my_gradient(f, c1));
disp(df_dc1(c1, c2, r1, r2));

% f = f(c1, c2, r1, r2);
% Jc1 =  df_dc1(c1, c2, r1, r2);
% Jr1 = df_dr1(c1, c2, r1, r2);
% Jc2 = df_dc2(c1, c2, r1, r2);
% Jr2 = df_dr2(c1, c2, r1, r2);
