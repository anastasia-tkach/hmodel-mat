...
%named_blocks{end + 1} = {'palm_middle', 'thumb_base', 'palm_back'};
%named_blocks{end + 1} = {'palm_middle', 'palm_index', 'thumb_base'};
%named_blocks{end + 1} = {'palm_index', 'palm_thumb', 'thumb_base'};
