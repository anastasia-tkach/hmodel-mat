...
centers_map('pinky_base') = [1.633; 1.216; -2.434];
...
centers_map('ring_base') = [1.076; 1.171; -2.364];
...
centers_map('middle_base') = [0.576; 1.226; -2.219];
...
centers_map('index_base') = [0.186; 1.204; -1.788];
radii_map('index_base') = 0.27;

%% Thumb
centers_map('thumb_fold') = [0.294; 0.816; -0.691];
radii_map('thumb_fold') = 0.2;

centers_map('thumb_additional') = [-1.014; 0.956; 0.584];
radii_map('thumb_additional') = 0.17;

centers_map('thumb_top') = [-0.758; 1.001; 0.41];
radii_map('thumb_top') = 0.23;
...
%% Palm top
centers_map('palm_pinky') = [1.61; 1.309; -2.378];
radii_map('palm_pinky') = 0.31;

centers_map('palm_ring') = [1.087; 1.458; -2.373];
radii_map('palm_ring') = 0.33;

centers_map('palm_middle') = [0.634; 1.437; -2.18];
radii_map('palm_middle') = 0.37;
...
centers_map('palm_side') = [1.738; 0.935; -2.172];
radii_map('palm_side') = 0.35;

centers_map('palm_center') = [1.014; 0.568; -1.793];
radii_map('palm_center') = 0.5;
