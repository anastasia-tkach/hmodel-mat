...
named_blocks{end + 1} = {'palm_back', 'palm_middle', 'palm_left'};
named_blocks{end + 1} = {'palm_middle', 'palm_index', 'palm_left'};
% named_blocks{end + 1} = {'palm_index', 'palm_thumb', 'palm_left'};
% named_blocks{end + 1} = {'palm_left', 'palm_thumb', 'thumb_base'};
...
names_map_keys = {
    ...
    'palm_pinky', 'palm_ring', 'palm_middle', 'palm_index', 'palm_thumb',  'palm_back',  'palm_right', 'palm_left', ...    
    'pinky_membrane', 'ring_membrane', 'middle_membrane', 'index_membrane', 'thumb_additional', 'thumb_fold', ...
