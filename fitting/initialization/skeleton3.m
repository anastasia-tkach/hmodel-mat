...
named_blocks{end + 1} = {'palm_bottom_left', 'palm_bottom_middle', 'palm_middle'};
named_blocks{end + 1} = {'palm_bottom_right', 'palm_bottom_middle', 'palm_middle'};

named_blocks{end + 1} = {'pinky_base', 'ring_base', 'palm_middle'};
named_blocks{end + 1} = {'ring_base', 'middle_base', 'palm_middle'};
named_blocks{end + 1} = {'middle_base', 'index_base', 'palm_middle'};
