...
%             model_points{i} = [];
%             axis_points{i} = [];
%             discarded_points{i} = data_points{i};
%             disp('discard');
%             continue;
%         end
...
[outline] = find_model_outline(centers, radii, blocks, palm_blocks, fingers_blocks, fingers_base_centers, camera_ray, verbose);
