function [pose] = render_data(pose, camera_axis, camera_center, view_axis, closing_radius, settings)
...
for i = 1:length(pose.points)
    ...
    back_map_for_rendered_data(round(m(2)), round(m(1)), :) = pose.points{i};
end
