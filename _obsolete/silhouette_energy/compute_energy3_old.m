...
for v = 1:D
    ...
    [raytracing_matrix, camera_axis, camera_center] = get_raytracing_matrix(pose.centers, radii, pose.data_bounding_box, view_axis, settings, 'front');
    if D == 2
    ...
    if D == 3 && display
        ...
        % mypoints(pose.model_projections_2D, 'b'); 
drawnow; 
    end
