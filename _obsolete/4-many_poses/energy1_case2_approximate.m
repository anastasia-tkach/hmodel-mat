...
function [f, Jc1, Jr1, Jc2, Jr2, t, r] = energy1_case2(p, c1, c2, r1, r2)
...
%J1 =  @(c1, c2, r1, r2) [df_dc1(c1, c2, r1, r2), df_dr1(c1, c2, r1, r2)];
%J2 = @(c1, c2, r1, r2) [df_dc2(c1, c2, r1, r2), df_dr2(c1, c2, r1, r2)]; 
% f_c1 = @(c1) f(c1, c2, r1, r2);
% f_c2 = @(c2) f(c1, c2, r1, r2);
% f_r1 = @(r1) f(c1, c2, r1, r2);
% f_r2 = @(r2) f(c1, c2, r1, r2);
% disp([gradient(f_c1, c1), gradient(f_r1, r1)]);
% disp(J1(c1, c2, r1, r2));
% disp([gradient(f_c2, c2), gradient(f_r2, r2)]);
% disp(J2(c1, c2, r1, r2));
