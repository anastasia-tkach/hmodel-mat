function [pose, f, Jc, Jr] = compute_energy3_2D(pose, radii, blocks, view_axis, H, W, D)
...
for i = 1:num_points
    ...
    [f_i, df_i, m_i, x_i] = energy3(centers, radii, model_points{i}, indices{i}, tangent_gradient, P, view_axis, H, W, rendered_data, distance_transform, gradient_directions);
